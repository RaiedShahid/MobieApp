...
export default class DeviceLostForm extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			personInfo: {
				...
				>
					<View>
						<View style={styles.heading}>
							<Text style={styles.text2}>Lost Device InFormation</Text>
						</View>
						...
						<View style={styles.heading}>
							<Text style={styles.text2}>Lost Details</Text>
						</View>
						<View style={styles.formBox}>
							<View style={styles.container}>
