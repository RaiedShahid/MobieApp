...
export default class CategoryListLost extends React.Component {
        ...
        return (
            <View style={styles.inputContainer}>
                <View style={{ width: '90%' }}>
                    ...
                    onPress={() => { this.props.navigation.navigate('LostForm') }}>
                    ...
                    <TouchableOpacity activeOpacity={0.8} style={styles.customButton}
                        onPress={() => { this.props.navigation.navigate('VehicleLostForm') }}>
                        <View style={styles.Button}>
                    ...
                    <TouchableOpacity activeOpacity={0.8} style={styles.customButton}
                        onPress={() => { this.props.navigation.navigate('DeviceLostForm') }}>
                        <View style={styles.Button}>
