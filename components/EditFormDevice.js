...
export default class EditFormDevice extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			personInfo: {
	...
	componentDidMount() {
		axios
			.get(
				`http://192.168.18.144:4000/home/${this.props.navigation.getParam(
					"_id"
				)}`
			)
			.then((res) => {
		...
		// console.log("ID", this.props.navigation.getParam("_id"));
	}
	handleSubmit = (e) => {
				...
				>
					<View>
						<View style={styles.heading}>
							<Text style={styles.text2}> Device InFormation</Text>
						</View>
						<View style={styles.formBox}>
							...
							<View style={styles.container}>
								<Text style={styles.text}>IME Number</Text>
							</View>
							<View style={styles.iconBox}>
								<TextInput
								...
								<View>
									...
									<View style={styles.container}>
										...
										>
											...
											<Picker.Item label="Q Mobile" value="Q Mobile" />
							...
							>
								<View style={{ width: "80%" }}>
									<Button
										...
										title="Upload Image"
										onPress={() => {
											this.props.navigation.navigate("ImageOptionForVehicle", {
